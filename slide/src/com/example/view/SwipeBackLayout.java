...
import com.example.listener.IPopbackListener;
...
public class SwipeBackLayout extends FrameLayout {
	...
	private IPopbackListener	mCallBack;
	...
	public void attachToActivity(IPopbackListener listener) {
		this.mCallBack = listener;
		TypedArray a = mCallBack.getAttachActivity().getTheme().obtainStyledAttributes(new int[] { android.R.attr.windowBackground });
		int background = a.getResourceId(0, 0);
		a.recycle();
		ViewGroup decor = (ViewGroup) mCallBack.getAttachActivity().getWindow().getDecorView();
